...
<head>
    ...
    <style>
        a {
            color: white; /* สีของลิงก์เป็นสีขาว */
        }

        /* สีของลิงก์เมื่อมีการ hover */
        a:hover {
            color: yellow; /* เปลี่ยนสีเมื่อ hover */
        }
        ...
        .navbar-nav .nav-link {
            color: white; /* สีของลิงก์ใน navbar */
        }

        /* เพิ่มลักษณะการแสดงผลที่เหมาะสม */
        .navbar-nav .nav-link:hover {
            color: cyan; /* สีเมื่อ hover */
        }
    </style>
</head>
...
<nav class="navbar navbar-expand-lg navbar-custom w-100">
    <div class="container-fluid">
        <a class="navbar-brand text-white" href="/">ระบบลงทะเบียน</a>
